...
class WriterPluginManager extends AbstractPluginManager
{
    ...
    protected $factories = [
        ...
        Writer\Mongo::class          => InvokableFactory::class,
        Writer\MongoDB::class        => InvokableFactory::class,
        ...
        'zendlogwritermongo'          => InvokableFactory::class,
        'zendlogwritermongodb'        => InvokableFactory::class,
